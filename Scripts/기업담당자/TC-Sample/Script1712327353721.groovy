...
WebUI.setText(findTestObject('Object Repository/Page_wiselection/input__userId'), 'mgt1125')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_wiselection/input__pw'), '4nvbrPglk7k=')

WebUI.click(findTestObject('Object Repository/Page_wiselection/button_'))
