...
WebUI.verifyElementText(findTestObject('Object Repository/Mangement/채용목록화면/a_(공고명)'), '[김준영] 정량평가 테스트 공고명')

WebUI.click(findTestObject('Object Repository/Mangement/채용목록화면/a_(공고명)'))

WebUI.verifyElementText(findTestObject('Object Repository/Mangement/채용목록화면/h2__2'), '[아던트_계열사2] [김준영] 정량평가 테스트 공고명')
